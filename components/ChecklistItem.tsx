...
const ChecklistItem: React.FC<ChecklistItemProps> = ({ task, onUpdate }) => {
  ...
  const handleClearPhoto = () => {
    if (window.confirm('Deseja remover a foto atual para tirar outra?')) {
      onUpdate({
        ...task,
          ...
          {task.photoUrl ? (
            <div className="relative group">
              ...
              <button
                ...
                className="absolute -top-2 -right-2 w-7 h-7 bg-red-500 text-white rounded-full flex items-center justify-center shadow-lg border-2 border-white hover:bg-red-600 transition-all active:scale-90"
